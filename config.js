...
export const UNIT_MODEL_MAP = {
  worker: { file: 'monk.gltf', scale: 0.78, y: -0.42, rotY: Math.PI },
  militia: { file: 'warrior.gltf', scale: 0.82, y: -0.42, rotY: Math.PI },
  swordsman: { file: 'rogue.gltf', scale: 0.8, y: -0.42, rotY: Math.PI },
  raider: { file: 'rogue.gltf', scale: 0.8, y: -0.42, rotY: Math.PI },
  raiderArcher: { file: 'ranger.gltf', scale: 0.82, y: -0.42, rotY: Math.PI },
  brute: { file: 'warrior.gltf', scale: 0.96, y: -0.42, rotY: Math.PI },
  wolfRider: { file: 'wizard.gltf', scale: 0.86, y: -0.42, rotY: Math.PI },
};
